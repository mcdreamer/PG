...
void MainMenuScene::initScene(PG::AppHostServices& appHostServices, PG::SceneHandle scene)
{
	...
	ui.pushElement(new PG::Button(btnPts[0], "Buttons Test", TagConstants::kShowButtonsTest));
	ui.pushElement(new PG::Button(btnPts[1], "Animations Test", TagConstants::kShowAnimationsTest));
	ui.pushElement(new PG::Button(btnPts[2], "Physics Test", TagConstants::kShowPhysicsTest));
	ui.pushElement(new PG::Button(btnPts[3], "Inventory Test", TagConstants::kShowInventoryTest));
	ui.pushElement(new PG::Button(btnPts[4], "Bar Test", TagConstants::kShowBarTest));
	ui.pushElement(new PG::Button(btnPts[5], "Sound Test", TagConstants::kShowSoundTest));
	ui.pushElement(new PG::Button(btnPts[6], "Camera Test", TagConstants::kShowCameraTest));
	ui.pushElement(new PG::Button(btnPts[7], "Exit", TagConstants::kExitApp));
}
